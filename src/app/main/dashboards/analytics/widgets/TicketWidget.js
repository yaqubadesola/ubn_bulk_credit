...
const TicketWidget = ({data, theme, status}) => {
    ...
    return (
        <Card className="w-full rounded-8 shadow-none border-1">
            ...
            <div className="p-16 pb-0 flex flex-row flex-wrap items-end">
                ...
                <div className="pr-16">
                    <Typography className="h3" color="textSecondary">Accounts</Typography>
...
export default withStyles(null, {withTheme: true})(TicketWidget);
