...
class SuccessfulUploadDetails extends Component {
    state = {
        filteredData: [],
        searchValue: null,
    };
    ...
    orderSuccessfulUploadDeatils = (data) => {
    ...
    render() {
        ...
        console.log(size);
        let allSuccessfulUploadDetails = data;
        allSuccessfulUploadDetails =
            searchValue && searchValue.length > 0
                ? this.orderSuccessfulUploadDeatils(filteredData)
                : this.orderSuccessfulUploadDeatils(data);
        const columns = [
            {
                name: 'id',
                label: 'S/N',
        ...
        const options = {
            ...
            downloadOptions: { filename: 'AllSuccessfulUploadDeatilsReport.csv', separator: ',' },
            ...
            onTableChange: (action, tableState) => {
                ...
                switch (action) {
                    ...
                    case 'search':
                        this.searchTable(allSuccessfulUploadDetails, tableState.searchText);
        ...
        return (
            <React.Fragment>
                ...
                <FuseAnimate animation="transition.slideUpIn" delay={300}>
                    <MUIDataTable
                        title={'All Successful Uploads'}
                        data={allSuccessfulUploadDetails}
                        columns={columns}
                        options={options}
                    />
                </FuseAnimate>
...
export default withStyles(styles, { withTheme: true })(
    withRouter(connect(mapStateToProps, mapDispatchToProps)(SuccessfulUploadDetails))
);
