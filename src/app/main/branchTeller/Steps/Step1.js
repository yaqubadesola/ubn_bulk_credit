...
class Step1 extends Component {
    render() {
        const { state, handleChange, classes, handleBvn } = this.props;
            ...
            <Paper style={myStyles.steps} style={{ padding: '2em', textAlign: 'center' }}>
                <div className={classes.gridContainer}>
                    ...
                    <div
                        ...
                        style={{ fontWeight: 'bold', fontSize: '20px', padding: '1em' }}
                    >
                        {renderText({
                            label: 'Select Month!',
                            type: 'h4',
                                ...
                                {state.loading ? (
                                    ...
                                    <div style={{ Padding: '2em', marginTop: '2em' }}>
                                        {renderButton({
                                            ...
                                            custom: true,
                                            fullWidth: true,
                                            onClick: () => handleBvn(state.form.bvn, false),
                                            disabled: state.stepSaveFlag,
                                        })}
                                    </div>
                                )}
                            </div>
