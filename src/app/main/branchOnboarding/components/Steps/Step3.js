    ...
    return (
        <Paper style={myStyles.steps}>
            ...
            <span  style={{fontWeight:"bold", fontSize:"20px"}}>
              {renderText({
                label: "Confirm Customer's BVN Details",
                type: "h4",
                color: "textPrimary",
                align: "center",
              })}
...
{/*                 
            ...
            <Grid container spacing={24} style={{ marginBottom: "16px", marginTop: "3em"}}>
              ...
              <Grid item xs={12} sm={6} md={6}>
                ...
                :
                <Grid display="flex"  width={"100%"}  height={60} >
                  {renderButton({ label: "Create New Customer", variant:"contained", custom: true, fullWidth:true, onClick: () => createM36User(state.form)})}
                </Grid> 
                }
              </Grid>
            </Grid>
