...
const AdminsHeader = ({setSearchText, searchText, mainTheme}) => {
        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">Administrative Users</Typography>
                </FuseAnimate>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminsHeader);
