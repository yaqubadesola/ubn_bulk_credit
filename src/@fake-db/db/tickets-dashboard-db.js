...
mock.onGet('/api/ticket-dashboard-app/widgets').reply((config) =>
{
    return [200, ticketsDashboardAppDB.widgets];
});

mock.onGet('/api/ticket-dashboard-app/projects').reply((config) =>
{
    return [200, ticketsDashboardAppDB.projects];
});
